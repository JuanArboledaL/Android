...
public class ProveedorContactos extends ContentProvider {

    private static final String AUTHORITY = "com.example.actividadevaluativat7";
    ...
    public static final class Contactos implements BaseColumns {
        ...
        public static final String COL_NUMBER = "telefono";
        public static final String COL_AVATAR = "personaje";
    }

    private BasedeDatos bbddContactos;
    ...
    public boolean onCreate() {
        bbddContactos = new BasedeDatos(getContext(),BD_NOMBRE, null, BD_VERSION);
        return true;
    }
